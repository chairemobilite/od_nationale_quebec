...
// Now we're in the segments section, instead of filling the trips section, click on the "Trips" button
testHelpers.changePageFromNavBar({ context, buttonText: 'Trips', nextPageUrl: 'survey/tripsIntro' });

// Click on the "Continue" button to go to survey
testHelpers.inputNextButtonTest({ context, text: 'Continue', nextPageUrl: '/survey/visitedPlaces' });

// Click on the third delete button to delete the last visited place
