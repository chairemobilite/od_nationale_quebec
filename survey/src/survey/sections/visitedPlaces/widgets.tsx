...
export const visitedPlacesActivePersonTitle: WidgetConfig.TextWidgetConfig = {
    ...
    text: (t: TFunction, interview, path) => {
        ...
        return t('visitedPlaces:activePersonTitle', {
            nickname
        });
    },
...
export const visitedPlacesButtonSwitchPerson = customWidgets.visitedPlacesButtonSwitchPerson;
